...
if ($_POST) {
    ...
    $sentencia=$conexion->prepare("INSERT INTO `tbl_colaboradores` (`id`, `titulo`, `descripcion`, `linkfacebook`, `linkinstagram`, `linklinkedin`, `foto`) VALUES (NULL, :titulo, :descripcion, :linkfacebook, :linkinstagram, :linklinkedin, :foto); ");
...
<div class="card">
    ...
    <button type="submit" class="btn btn-success">Crear Colaboradores</button>
    <a  name=""
        id=""
